...
if ($Switch=="ON") {shell_exec('wget http://192.168.1.xxx/?REMOTE=ON');
sleep(2);}
elseif ($Switch=="OFF") {shell_exec('wget http://192.168.1.xxx/?REMOTE=OFF');
sleep(2);}
elseif ($Switch=="TOGGLE") {shell_exec('wget http://192.168.1.xxx/?REMOTE=TOGGLE');
sleep(2);}
//********************************************
?>
